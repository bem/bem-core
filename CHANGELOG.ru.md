...
- Исправлена утечка памяти в `i-bem__dom` ([#1536](https://github.com/bem/bem-core/pull/1536)).

### Также в релиз вошли следующие изменения

- Модуль `inherit` обновлен до `2.2.6` ([#1520](https://github.com/bem/bem-core/pull/1520)).
