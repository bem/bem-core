...
The block's implementation in the technologies CSS and JS is not a part of the BEMHTML templating engine. However in any real-world project CSS and JS are used together with the BEMHTML.
