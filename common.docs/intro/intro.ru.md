...
## Шаг 1. Инициализировать проект <a id="init"></a>
...
## Шаг 2. Создать макет страницы <a id="page"></a>
...
## Шаг 3. Добавить блок <a id="block"></a>
...
## Шаг 4. Написать шаблон: приветствие по образцу <a id="template"></a>
...
## Шаг 5. Переписать шаблон: генерация списка по массиву элементов <a id="array"></a>
...
## Шаг 6. Дополнить шаблон: модифицировать HTML-теги <a id="tags"></a>
...
## Шаг 7. Настроить оформление и поведение блока (CSS и JS) <a id="cssjs"></a>
