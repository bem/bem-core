...
* Модуль [`i-bem`](https://github.com/bem/bem-core/blob/v1/common.blocks/i-bem/i-bem.vanilla.js).<br/>
  ...
  *i-bem.js*. Блок i-bem написан с расчетом на использование в любом
  ...
  Node.js).
* Модуль [`i-bem__dom`](https://github.com/bem/bem-core/blob/v1/common.blocks/i-bem/__dom/i-bem__dom.js).<br/> Базовая
...
пример см. в разделе [Инициализация/удаление блоков без DOM-представления](#init-bem).
