...
JavaScript-программисты взаимодействуют с DOM при помощи [специальных методов](https://developer.mozilla.org/ru/docs/Web/API/Document).

![DOM](https://rawgit.com/bem/bem-core/godfreyd-i-bem-js/common.docs/i-bem-js/i-bem-js-common__dom.svg)
...
![Virtual DOM](https://rawgit.com/bem/bem-core/godfreyd-i-bem-js/common.docs/i-bem-js/i-bem-js-common__virtual-dom.svg)
...
Обычно все JavaScript-реализации блоков [собирают в отдельный бандл](https://ru.bem.info/methodology/build/), который подключают на страницу. Тема сборки выходят за рамки этого документа, поэтому вы можете использовать готовые шаблонные репозитории, где сборка бандлов настроена по умолчанию:
